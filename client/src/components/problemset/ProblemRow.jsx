...
const ProblemRow = ({ id, title, slug, difficulty, solved }) => {
  ...
  return (
    <motion.div
      ...
      className="h-16 w-full flex justify-between items-center hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors cursor-pointer"
    >
      ...
      <div className="flex gap-3 justify-between w-30 items-center">
